...
namespace PrimerParcial.Controllers
{
    public class PaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idPais,nombre,Descripcion")] Pais pais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idPais,nombre,Descripcion")] Pais pais)
        {
            if (id != pais.idPais)
            {
                return NotFound();
