...
namespace PrimerParcial.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idMarca,Nombre,Descripcion")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idMarca,Nombre,Descripcion")] Marca marca)
        {
            if (id != marca.idMarca)
            {
                return NotFound();
